...
void mat_zero(mat_t* restrict A) {
    memset(A, 0, sizeof(mat_t));
}

void mat_eye(mat_t* restrict A) 
{
...
void mat_pos(const mat_t* A, mat_t* restrict B) {
    memcpy(B, A, sizeof(mat_t));
}

void mat_neg(const mat_t* A, mat_t* restrict B)
{
...
bool mat_inv(const mat_t* A, mat_t* restrict A_inv)
{
...
void vec_omul(const vec_t* u_bar, const vec_t* v_bar, mat_t* restrict A)
{
...
void vec_cross_mat(const vec_t* v_bar, mat_t* restrict A)
{
