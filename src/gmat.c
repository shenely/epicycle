...
void gvec_neg(const gvec_t u_bar, gvec_t v_bar)
{
...
bool gvec_unit(const gvec_t v_bar, gvec_t v_hat)
{
...
void gvec_add(const gvec_t u_bar, const gvec_t v_bar, gvec_t w_bar)
{
...
void gvec_sub(const gvec_t u_bar, const gvec_t v_bar, gvec_t w_bar)
{
...
void gvec_muls(const gvec_t u_bar, double s, gvec_t v_bar)
{
...
bool gmat_inv(const gmat_t A, gmat_t A_inv);
...
void gmat_mul(const gmat_t A, const gmat_t B, gmat_t C)
{
...
void gvec_omul(const gvec_t u_bar, const gvec_t v_bar, gmat_t A)
{
...
void gmat_mulv(const gmat_t A, const gvec_t u_bar, gvec_t v_bar)
{
...
void gmat_vmul(const gvec_t u_bar, const gmat_t A, gvec_t v_bar)
{
