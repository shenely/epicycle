...
const double Kg[(G_DEG+1)*(G_DEG+2)/2] = {
    ...
    sqrt(3.0), sqrt(3.0),
#if G_DEG >= 2
    sqrt(5.0), sqrt(5.0 / 3.0), sqrt(5.0 / 12.0),
#if G_DEG >= 3
    sqrt(7.0), sqrt(7.0 / 6.0), sqrt(7.0 / 70.0), sqrt(7.0 / 360.0),
#if G_DEG >= 4
    sqrt(9.0), sqrt(9.0 / 10.0), sqrt(1.0 / 20.0), sqrt(1.0 / 280.0), sqrt(1.0 / 2240.0)
#endif
#endif
#endif
#endif
