 ...
 */
bool dmat_inv(const dmat_t*, dmat_t* restrict);
 ...
 */
void dmat_mul(const dmat_t*, const dmat_t*, dmat_t* restrict);
 ...
 */
void dmat_muld(const mat_t*, const dmat_t*, mat_t* restrict);
 ...
 * :param mat_t* C: output matrix
 */
void dmat_dmul(const dmat_t*, const mat_t*, mat_t* restrict);
