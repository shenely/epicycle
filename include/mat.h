 ...
 */
void mat_zero(mat_t* restrict);

/* Identity matrix
 * :param mat_t* I: output matrix
 */
void mat_eye(mat_t* restrict);
 ...
 */
bool mat_inv(const mat_t*, mat_t* restrict);
 ...
 * :param mat_t* C: output matrix
 */
void mat_mul(const mat_t*, const mat_t*, mat_t* restrict);
 ...
 * :param mat_t* A: output matrix
 */
void vec_omul(const vec_t*, const vec_t*, mat_t* restrict);
 ...
 */
void mat_mulv(const mat_t*, const vec_t*, vec_t* restrict);
 ...
 * :param vec_t* v_bar: output vector
 */
void mat_vmul(const vec_t*, const mat_t*, vec_t* restrict);

/* Cross product matrix
 * :param vec_t* u_bar: input vector
 * :param mat_t* A: output matrix
 */
void vec_cross_mat(const vec_t*, mat_t* restrict);
